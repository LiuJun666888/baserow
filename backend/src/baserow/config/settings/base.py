...
# oauth第三方登陆配置
FELO_CODE_URL = 'https://passport.felo.me/oauth/authorize?'  # 请求code地址
FELO_TOKEN_URL = 'https://passport.felo.me/oauth/token'  # 通过code请求token地址
FELO_INFO_URL = 'https://open.felo.me/sdk/user/current'  # 通过token获取用户信息
FELO_CLIENT_ID = 'ydFC1EF960E67640199449EB2C6A6F3921'  # 应用ID
FELO_CLIENT_SECRET = 'JKxWwd9Q+8DMP0IFtam8JHDPVzdGvw0HWjRPdD42fSM='  # 应用密钥
FELO_REDIRECT_URI = 'http://localhost:3000/oauthLogin'  # 授权后携带授权码重定向到的网页地址（urlencode格式）
